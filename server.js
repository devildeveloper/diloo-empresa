...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _componentsHtml = __webpack_require__(117);
  ...
  var _compression = __webpack_require__(119);
  
  var _compression2 = _interopRequireDefault(_compression);
  
  var _bodyParser = __webpack_require__(120);
  
  var _bodyParser2 = _interopRequireDefault(_bodyParser);
  
  var server = global.server = (0, _express2['default'])();
  
  var api_key = 'key-641c453db00fe809ed107e5c413f53ab';
  var domain = 'app033a8d5317c54b0da7a3728394132f6d.mailgun.org';
  var mailgun = __webpack_require__(121)({ apiKey: api_key, domain: domain });
  ...
  // -----------------------------------------------------------------------------
  server.use('/api/content', __webpack_require__(122));
  
  //
  // Register server-side rendering middleware
  // -----------------------------------------------------------------------------
  
  server.post('/sendcontacto', function (req, res) {
    ...
    var data = {
      from: nombre + ' <' + email + '>',
      to: 'eugenio@diloo.com.pe , contacto@diloo.com.pe',
      subject: 'Contacto Diloo Web',
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _componentsLoginPage = __webpack_require__(105);
  
  var _componentsLoginPage2 = _interopRequireDefault(_componentsLoginPage);
  
  var _componentsRegisterPage = __webpack_require__(108);
  
  var _componentsRegisterPage2 = _interopRequireDefault(_componentsRegisterPage);
  
  var _componentsNotFoundPage = __webpack_require__(111);
  
  var _componentsNotFoundPage2 = _interopRequireDefault(_componentsNotFoundPage);
  
  var _componentsErrorPage = __webpack_require__(114);
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var InitPage = (function (_Component) {
    ...
    function InitPage(props) {
      ...
      this.state = { margin: 0, no_menu: true, open_menu: 0, sent: false, height: 600, on_servicio: 0, mouse_on: false, sms: false, modY: 0, elements: ['inicio', 'servicio', 'contacto'], time: '', scrolling: false, sales_state: 0 };
    }
    ...
    _createClass(InitPage, [{
      ...
      value: function sendContacto(e) {
        ...
        _superagent2['default'].post('/sendcontacto').send(data).end(function (err, res) {
          este.setState({ sent: true });
        });
      }
    }, {
      key: 'handleResize',
      ...
      value: function render() {
        ...
        var no_scroll = (0, _classnames2['default'])(_InitPageScss2['default'].root);
        if (this.props.servicio != null) {
          no_scroll = (0, _classnames2['default'])(_InitPageScss2['default'].root, _InitPageScss2['default'].no_scroll);
          arrow = (0, _classnames2['default'])(_InitPageScss2['default'].hide);
        }
        var on_this = _InitPageScss2['default'].on;
        return _react2['default'].createElement(
          'div',
          { className: no_scroll, onKeyPress: this._keyPress.bind(this) },
          _react2['default'].createElement(
            'div',
            { className: is_menu },
                    ...
                    (function () {
                      if (this.state.sent) {
                        ...
                        return _react2['default'].createElement(
                          ...
                          _react2['default'].createElement('input', { type: 'text', ref: 'apellido', placeholder: 'Apellido', className: (0, _classnames2['default'])(_InitPageScss2['default'].input, _InitPageScss2['default'].doble) }),
                          _react2['default'].createElement('input', { type: 'text', ref: 'email', placeholder: 'Email', className: (0, _classnames2['default'])(_InitPageScss2['default'].input, _InitPageScss2['default'].unico) }),
                          _react2['default'].createElement('textarea', { ref: 'mensaje', ref: 'comentario', placeholder: 'Comentarios', className: (0, _classnames2['default'])(_InitPageScss2['default'].input, _InitPageScss2['default'].unico) }),
                          _react2['default'].createElement('input', { type: 'submit', value: 'Enviar', className: (0, _classnames2['default'])(_InitPageScss2['default'].enviar), onClick: this.sendContacto.bind(this) })
                        );
                      }
                    }).call(this),
                    _react2['default'].createElement(
                ...
                _react2['default'].createElement(
                  ...
                  _react2['default'].createElement(
                    ...
                    _react2['default'].createElement(
                      ...
                      'Un cliente satisfecho vale más que mil palabras'
                    )
                  )
                ),
                _react2['default'].createElement(
          ...
          (function () {
            ...
            if (this.props.servicio == 'sms') {
              return _react2['default'].createElement(
                ...
                _react2['default'].createElement(
                  ...
                  _react2['default'].createElement(
                    'div',
                    { className: (0, _classnames2['default'])(_InitPageScss2['default'].fullwhite, _InitPageScss2['default'].center), style: { backgroundImage: 'url(' + __webpack_require__(56) + ')' } },
                  ...
                  _react2['default'].createElement(
                    ...
                    _react2['default'].createElement(
                      ...
                      _react2['default'].createElement(
                        ...
                        _react2['default'].createElement('img', { className: (0, _classnames2['default'])(_InitPageScss2['default'].margin50t, _InitPageScss2['default'].movil_hide), src: __webpack_require__(58) }),
                        _react2['default'].createElement(
                          'p',
                          null,
                          'Envio SMS a todos los operadores de Perú y Latam'
                        ),
                        _react2['default'].createElement('img', { src: __webpack_require__(59), className: _InitPageScss2['default'].movil_hide }),
                        _react2['default'].createElement(
                          'p',
                          null,
                          'Posibilidad de enviar mensajes customizados con el nombre del cliente, montos, tipo producto, entre otros.'
                        )
                      ),
                      _react2['default'].createElement(
                        'div',
                        { className: (0, _classnames2['default'])(_InitPageScss2['default'].right_block, _InitPageScss2['default'].right_block_b) },
                        _react2['default'].createElement('img', { className: (0, _classnames2['default'])(_InitPageScss2['default'].margin50t, _InitPageScss2['default'].movil_hide), src: __webpack_require__(60) }),
                        _react2['default'].createElement(
                          'p',
                          null,
                          'Capacidad de procesar hasta 100,000 mensajes de texto por hora'
                        ),
                        _react2['default'].createElement('img', { src: __webpack_require__(61), className: _InitPageScss2['default'].movil_hide }),
                        _react2['default'].createElement(
                          'p',
                          null,
                          'Ejecución inmediata y con diferentes alternativas: ordenes de trabajo vía mail, acceso a nuestra plataforma web de envios o mediante web service.'
                        )
                      )
                    ),
                    _react2['default'].createElement(
                      ...
                      _react2['default'].createElement(
                        'div',
                        { className: (0, _classnames2['default'])(_InitPageScss2['default'].left_block, _InitPageScss2['default'].left_block_b) },
                        _react2['default'].createElement('img', { src: __webpack_require__(62), className: (0, _classnames2['default'])(_InitPageScss2['default'].icon_smalled, _InitPageScss2['default'].sms_img) }),
                        _react2['default'].createElement('br', null),
                        _react2['default'].createElement(
                          'h4',
                          { className: (0, _classnames2['default'])(_InitPageScss2['default'].thin, _InitPageScss2['default'].sub_smalled, _InitPageScss2['default'].margin_v, _InitPageScss2['default'].cel_txt_sms) },
                      ...
                      _react2['default'].createElement(
                        'div',
                        { className: _InitPageScss2['default'].center_block },
                        _react2['default'].createElement('img', { className: (0, _classnames2['default'])(_InitPageScss2['default'].margin50t, _InitPageScss2['default'].movil_hide), src: __webpack_require__(63) }),
                        _react2['default'].createElement(
                          'p',
                          null,
                          'Permite la interacción con clientes de manera innovadora. '
                        )
                      ),
                      _react2['default'].createElement(
                        'div',
                        { className: (0, _classnames2['default'])(_InitPageScss2['default'].right_block, _InitPageScss2['default'].right_block_b) },
                        _react2['default'].createElement('img', { className: (0, _classnames2['default'])(_InitPageScss2['default'].margin50t, _InitPageScss2['default'].movil_hide), src: __webpack_require__(64) }),
                        _react2['default'].createElement(
                          'p',
                          null,
                          'Ideal para la activación de promociones, sorteos e implementación de campañas a medida.'
                        )
                      )
                    ),
                    _react2['default'].createElement(
                      ...
                      _react2['default'].createElement(
                        'div',
                        { className: (0, _classnames2['default'])(_InitPageScss2['default'].left_block, _InitPageScss2['default'].left_block_b) },
                        _react2['default'].createElement('img', { src: __webpack_require__(65), className: (0, _classnames2['default'])(_InitPageScss2['default'].icon_smalled, _InitPageScss2['default'].sms_img) }),
                        _react2['default'].createElement(
                          'h4',
                      ...
                      _react2['default'].createElement(
                        'div',
                        { className: _InitPageScss2['default'].center_block },
                        _react2['default'].createElement('img', { className: (0, _classnames2['default'])(_InitPageScss2['default'].margin50t, _InitPageScss2['default'].movil_hide), src: __webpack_require__(66) }),
                        _react2['default'].createElement(
                          'p',
                          null,
                          'Creamos en cuestión de horas “landing pages” para desplegar contenidos, fotos o infografías en los telefonos móviles a través de un SMS.'
                        )
                      ),
                      _react2['default'].createElement(
                        'div',
                        { className: (0, _classnames2['default'])(_InitPageScss2['default'].right_block, _InitPageScss2['default'].right_block_b) },
                        _react2['default'].createElement('img', { className: (0, _classnames2['default'])(_InitPageScss2['default'].margin50t, _InitPageScss2['default'].movil_hide), src: __webpack_require__(67) }),
                        _react2['default'].createElement(
                          'p',
                          null,
                          'El servicio permite enriquecer bases de datos, activar promociones y tener respuestas de clientes gracias al detalle de nuestros reportes.'
                        )
                      )
                    )
                  )
            ...
            if (this.props.servicio == 'voz') {
              return _react2['default'].createElement(
                ...
                _react2['default'].createElement(
                  'div',
                  { className: (0, _classnames2['default'])(_InitPageScss2['default'].fullwhite, _InitPageScss2['default'].center), style: { backgroundImage: 'url(' + __webpack_require__(68) + ')' } },
                ...
                _react2['default'].createElement(
                  ...
                  _react2['default'].createElement(
                    ...
                    _react2['default'].createElement('img', { src: __webpack_require__(69), style: { width: '45%' } }),
                    _react2['default'].createElement(
                      'p',
                      null,
                  ...
                  _react2['default'].createElement(
                    'div',
                    { className: (0, _classnames2['default'])(_InitPageScss2['default'].globo, _InitPageScss2['default'].cel_globo) },
                    _react2['default'].createElement('img', { src: __webpack_require__(70), style: { width: '45%' } }),
                    _react2['default'].createElement(
                      'p',
                      null,
                  ...
                  _react2['default'].createElement(
                    ...
                    _react2['default'].createElement('img', { src: __webpack_require__(71), style: { width: '45%' } }),
                    _react2['default'].createElement(
                      'p',
                      null,
                  ...
                  _react2['default'].createElement(
                    'div',
                    { className: (0, _classnames2['default'])(_InitPageScss2['default'].globo, _InitPageScss2['default'].no_margin, _InitPageScss2['default'].cel_globo) },
                    _react2['default'].createElement('img', { src: __webpack_require__(72), style: { width: '45%' } }),
                    _react2['default'].createElement(
                      'p',
                      null,
                  ...
                  _react2['default'].createElement(
                    'div',
                    { className: (0, _classnames2['default'])(_InitPageScss2['default'].globo, _InitPageScss2['default'].no_margin, _InitPageScss2['default'].cel_globo) },
                    _react2['default'].createElement('img', { src: __webpack_require__(73), style: { width: '45%' } }),
                    _react2['default'].createElement(
                      'p',
                      null,
            ...
            if (this.props.servicio == 'sales') {
              return _react2['default'].createElement(
                ...
                _react2['default'].createElement(
                  'div',
                  { className: (0, _classnames2['default'])(_InitPageScss2['default'].fullwhite, _InitPageScss2['default'].center), style: { backgroundImage: 'url(' + __webpack_require__(74) + ')' } },
                    ...
                    _react2['default'].createElement(
                      ...
                      _react2['default'].createElement(
                        ...
                        _react2['default'].createElement(
                          ...
                          _react2['default'].createElement('img', { src: __webpack_require__(76), style: { width: '80%' } })
                        )
                      ),
                      _react2['default'].createElement(
                        'div',
                      ...
                      _react2['default'].createElement(
                        ...
                        _react2['default'].createElement(
                          ...
                          _react2['default'].createElement(
                            ...
                            _react2['default'].createElement(
                              ...
                              _react2['default'].createElement(
                                'p',
                                { style: { fontSize: '14px' } },
                                'Planeamiento estratégico y personalizado de acuerdo a la necesidad del cliente.'
                              )
                            )
                          ),
                          _react2['default'].createElement(
                          ...
                          _react2['default'].createElement(
                            'div',
                            { className: (0, _classnames2['default'])(_InitPageScss2['default'].two) },
                            _react2['default'].createElement('img', { src: __webpack_require__(88) }),
                            _react2['default'].createElement(
                              'div',
                              { className: _InitPageScss2['default'].cel_nopad, style: { clear: 'both', paddingTop: '10px', paddingBottom: '30px' } },
                              _react2['default'].createElement(
                        ...
                        _react2['default'].createElement(
                          ...
                          _react2['default'].createElement(
                            ...
                            _react2['default'].createElement(
                              ...
                              _react2['default'].createElement('img', { src: __webpack_require__(89), className: (0, _classnames2['default'])(_InitPageScss2['default'].img_left, _InitPageScss2['default'].ctc_img) }),
                              _react2['default'].createElement(
                                'p',
                          ...
                          _react2['default'].createElement('img', { src: __webpack_require__(90), className: (0, _classnames2['default'])(_InitPageScss2['default'].rotate_movil, _InitPageScss2['default'].flecha_roja), style: { float: 'left', marginTop: '40px' } }),
                          _react2['default'].createElement(
                            'div',
                            { className: (0, _classnames2['default'])(_InitPageScss2['default'].one, _InitPageScss2['default'].one_reg), style: { width: '20%' } },
                            _react2['default'].createElement(
                              'div',
                              { className: _InitPageScss2['default'].size_box },
                              _react2['default'].createElement('img', { src: __webpack_require__(91), className: (0, _classnames2['default'])(_InitPageScss2['default'].img_left, _InitPageScss2['default'].ctc_img) }),
                              _react2['default'].createElement(
                                'p',
                                { className: _InitPageScss2['default'].ctc_txt_gris },
                          ...
                          _react2['default'].createElement(
                            ...
                            _react2['default'].createElement(
                              'div',
                              { className: _InitPageScss2['default'].size_box },
                              _react2['default'].createElement('img', { src: __webpack_require__(92), className: (0, _classnames2['default'])(_InitPageScss2['default'].img_left, _InitPageScss2['default'].ctc_img) }),
                              _react2['default'].createElement(
                                'p',
                                { className: _InitPageScss2['default'].ctc_txt_gris },
                      ...
                      _react2['default'].createElement(
                        ...
                        _react2['default'].createElement(
                          ...
                          _react2['default'].createElement(
                            ...
                            _react2['default'].createElement('img', { src: __webpack_require__(93) })
                          ),
                          _react2['default'].createElement(
                            'div',
                            { className: _InitPageScss2['default'].clientes_img },
                            _react2['default'].createElement('img', { src: __webpack_require__(94) })
                          ),
                          _react2['default'].createElement(
                            'div',
                            { className: _InitPageScss2['default'].clientes_img },
                            _react2['default'].createElement('img', { src: __webpack_require__(95) })
                          ),
                          _react2['default'].createElement(
                            'div',
                            { className: _InitPageScss2['default'].clientes_img },
                            _react2['default'].createElement('img', { src: __webpack_require__(96) })
                          )
                        ),
                        _react2['default'].createElement(
                          'div',
            ...
            if (this.props.servicio == 'mailing') {
              return _react2['default'].createElement(
                ...
                _react2['default'].createElement(
                  'div',
                  { className: (0, _classnames2['default'])(_InitPageScss2['default'].fullwhite, _InitPageScss2['default'].center), style: { backgroundImage: 'url(' + __webpack_require__(97) + ')' } },
                ...
                _react2['default'].createElement(
                  ...
                  _react2['default'].createElement(
                    ...
                    _react2['default'].createElement(
                      ...
                      _react2['default'].createElement('img', { src: __webpack_require__(98), className: _InitPageScss2['default'].img_head_mailing })
                    ),
                    _react2['default'].createElement(
                      'div',
                  ...
                  _react2['default'].createElement(
                    'div',
                    { className: (0, _classnames2['default'])(_InitPageScss2['default'].demargin_movil, _InitPageScss2['default'].top_mailing, _InitPageScss2['default'].clearfix) },
                    _react2['default'].createElement(
                      'div',
                      ...
                      _react2['default'].createElement(
                        ...
                        _react2['default'].createElement('img', { src: __webpack_require__(99), className: (0, _classnames2['default'])(_InitPageScss2['default'].img_responsive, _InitPageScss2['default'].img_mailing) }),
                        _react2['default'].createElement(
                          'h4',
                    ...
                    _react2['default'].createElement(
                      ...
                      _react2['default'].createElement(
                        'div',
                        { className: (0, _classnames2['default'])(_InitPageScss2['default'].two, _InitPageScss2['default'].center, _InitPageScss2['default'].no_margin, _InitPageScss2['default'].cel_mailing) },
                        _react2['default'].createElement('img', { src: __webpack_require__(100), className: (0, _classnames2['default'])(_InitPageScss2['default'].img_responsive, _InitPageScss2['default'].img_mailing) }),
                        _react2['default'].createElement(
                          'h4',
                          { className: (0, _classnames2['default'])(_InitPageScss2['default'].no_margin, _InitPageScss2['default'].sub_img, _InitPageScss2['default'].tit_mailing) },
                          'CONTACTOS'
                    ...
                    _react2['default'].createElement(
                      ...
                      _react2['default'].createElement(
                        'div',
                        { className: (0, _classnames2['default'])(_InitPageScss2['default'].two, _InitPageScss2['default'].center, _InitPageScss2['default'].no_margin, _InitPageScss2['default'].cel_mailing) },
                        _react2['default'].createElement('img', { src: __webpack_require__(101), className: (0, _classnames2['default'])(_InitPageScss2['default'].img_responsive, _InitPageScss2['default'].img_mailing) }),
                        _react2['default'].createElement(
                          'h4',
                          { className: (0, _classnames2['default'])(_InitPageScss2['default'].no_margin, _InitPageScss2['default'].sub_img, _InitPageScss2['default'].tit_mailing) },
                          'DISEÑO'
                    ...
                    _react2['default'].createElement(
                      ...
                      _react2['default'].createElement(
                        'div',
                        { className: (0, _classnames2['default'])(_InitPageScss2['default'].two, _InitPageScss2['default'].center, _InitPageScss2['default'].no_margin, _InitPageScss2['default'].cel_mailing) },
                        _react2['default'].createElement('img', { src: __webpack_require__(102), className: (0, _classnames2['default'])(_InitPageScss2['default'].img_responsive, _InitPageScss2['default'].img_mailing) }),
                        _react2['default'].createElement(
                          'h4',
                          { className: (0, _classnames2['default'])(_InitPageScss2['default'].no_margin, _InitPageScss2['default'].sub_img, _InitPageScss2['default'].tit_mailing) },
                          'SERVICIO'
                    ...
                    _react2['default'].createElement(
                      ...
                      _react2['default'].createElement(
                        'div',
                        { className: (0, _classnames2['default'])(_InitPageScss2['default'].two, _InitPageScss2['default'].center, _InitPageScss2['default'].no_margin, _InitPageScss2['default'].cel_mailing) },
                        _react2['default'].createElement('img', { src: __webpack_require__(103), className: (0, _classnames2['default'])(_InitPageScss2['default'].img_responsive, _InitPageScss2['default'].img_mailing) }),
                        _react2['default'].createElement(
                          'h4',
                          { className: (0, _classnames2['default'])(_InitPageScss2['default'].no_margin, _InitPageScss2['default'].sub_img, _InitPageScss2['default'].tit_mailing) },
                          'PERSONALIZACIÓN'
                    ...
                    _react2['default'].createElement(
                      ...
                      _react2['default'].createElement(
                        'div',
                        { className: (0, _classnames2['default'])(_InitPageScss2['default'].two, _InitPageScss2['default'].center, _InitPageScss2['default'].no_margin, _InitPageScss2['default'].cel_mailing) },
                        _react2['default'].createElement('img', { src: __webpack_require__(104), className: (0, _classnames2['default'])(_InitPageScss2['default'].img_responsive, _InitPageScss2['default'].img_mailing) }),
                        _react2['default'].createElement(
                          'h4',
                          { className: (0, _classnames2['default'])(_InitPageScss2['default'].no_margin, _InitPageScss2['default'].sub_img, _InitPageScss2['default'].tit_mailing) },
                          'AUTOMATIZACION'
...
/***/ function(module, exports, __webpack_require__) {
  ...
  exports.locals = {
  	...
  	"overflow": "InitPage_overflow_10q",
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var Header = (function (_Component) {
    ...
    _createClass(Header, [{
      ...
      key: 'toggleOutClick',
      value: function toggleOutClick(e) {
        e.preventDefault();
      ...
      value: function render() {
        ...
        return _react2['default'].createElement(
          ...
          _react2['default'].createElement(_Navigation2['default'], { className: _HeaderScss2['default'].nav, menu: this.props.menu, onClick: this.toggleOutClick.bind(this) }),
          _react2['default'].createElement(
            _Link2['default'],
    ...
    _createClass(Navigation, [{
      ...
      value: function render() {
        ...
        return _react2['default'].createElement(
          ...
          _react2['default'].createElement(
            'a',
            { className: (0, _classnames2['default'])(_NavigationScss2['default'].link, { 'menu-on': this.props.menu == 'inicio' }), href: '/inicio', onClick: function (e) {
                _Link2['default'].handleClick(e);este.props.onClick(e);
              }, to: '/inicio' },
          ...
          _react2['default'].createElement(
            'a',
            { className: (0, _classnames2['default'])(_NavigationScss2['default'].link, { 'menu-on': this.props.menu == 'servicios' }), href: '/servicios', onClick: function (e) {
                _Link2['default'].handleClick(e);este.props.onClick(e);
              } },
            _react2['default'].createElement('span', { className: _NavigationScss2['default'].circle }),
            ' Servicios'
          ...
          _react2['default'].createElement(
            'a',
            { className: (0, _classnames2['default'])(_NavigationScss2['default'].link, { 'menu-on': this.props.menu == 'contacto' }), onClick: function (e) {
                _Link2['default'].handleClick(e);este.props.onClick(e);
              }, href: '/contacto' },
            _react2['default'].createElement('span', { className: _NavigationScss2['default'].circle }),
            ' Contacto'
          ...
          _react2['default'].createElement(
            'a',
            { className: (0, _classnames2['default'])(_NavigationScss2['default'].link, { 'menu-on': this.props.menu == 'clientes' }), href: '/clientes', onClick: function (e) {
                _Link2['default'].handleClick(e);este.props.onClick(e);
              } },
            _react2['default'].createElement('span', { className: _NavigationScss2['default'].circle }),
            ' Clientes'
...
/***/ function(module, exports) {
  ...
  module.exports = "data:image/png;base64,"

/***/ },
/* 59 */
/***/ function(module, exports) {

  module.exports = "data:image/png;base64,"

/***/ },
/* 60 */
/***/ function(module, exports) {

  module.exports = "data:image/png;base64,"

/***/ },
/* 61 */
/***/ function(module, exports) {

  module.exports = "data:image/png;base64,"
...
/***/ function(module, exports) {
  ...
  module.exports = "data:image/png;base64,"

/***/ },
/* 64 */
/***/ function(module, exports) {

  module.exports = "data:image/png;base64,"
...
/***/ function(module, exports) {
  ...
  module.exports = "data:image/png;base64,"

/***/ },
/* 67 */
/***/ function(module, exports) {

  module.exports = "data:image/png;base64,"
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _LoginPageScss = __webpack_require__(106);
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _RegisterPageScss = __webpack_require__(109);
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _NotFoundPageScss = __webpack_require__(112);
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _ErrorPageScss = __webpack_require__(115);
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _fs = __webpack_require__(123);
  ...
  var _bluebird = __webpack_require__(124);
  ...
  var _frontMatter = __webpack_require__(126);
